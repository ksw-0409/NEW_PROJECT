...
Shader "Vefects/SH_Vefects_HDRP_Unlit_Flipbook_Pixel_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord122 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float4 lerpResult88 = lerp( ( packedInput.ase_color * lerpResult111 ) , packedInput.ase_color , _FlatColor);
				float4 color125 = ( lerpResult88 * _Emissive );
				
				float mainTex_VC_alha52 = packedInput.ase_color.a;
				float mainTex_alpha48 = tex2DNode45.a;
				float opacity61 = ( mainTex_VC_alha52 * mainTex_alpha48 );
				
				surfaceDescription.Color = color125.rgb;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float mainTex_VC_alha52 = packedInput.ase_color.a;
				float2 texCoord122 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode45 = tex2D( _MainTexture, texCoord122 );
				float mainTex_alpha48 = tex2DNode45.a;
				float opacity61 = ( mainTex_VC_alha52 * mainTex_alpha48 );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord122 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode45 = tex2D( _MainTexture, texCoord122 );
				float4 lerpResult97 = lerp( _Outline , _B , tex2DNode45.b);
				float4 lerpResult112 = lerp( lerpResult97 , _G , tex2DNode45.g);
				float4 lerpResult111 = lerp( lerpResult112 , _R , tex2DNode45.r);
...
WireConnection;128;2;73;0
ASEEND*/
//CHKSM=54AB3E2D6E5BF507BFD20108A0A76B807389AF0D