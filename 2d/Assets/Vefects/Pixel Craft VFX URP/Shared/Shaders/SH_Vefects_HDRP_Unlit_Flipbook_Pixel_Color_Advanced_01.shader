...
Shader "Vefects/SH_Vefects_HDRP_Unlit_Flipbook_Pixel_Color_Advanced_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord19 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float mainTex_VC_alpha52 = packedInput.ase_color.a;
				float Opacity_VTC_W33 = packedInput.ase_texcoord1.z;
				float Opacity_VTC_T30 = packedInput.ase_texcoord1.w;
				float temp_output_44_0 = (( Opacity_VTC_T30 - 1.0 ) + (Opacity_VTC_W33 - 0.0) * (1.0 - ( Opacity_VTC_T30 - 1.0 )) / (1.0 - 0.0));
				float2 texCoord133 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float flipbook_X137 = _FlipbookX;
				float flipbook_Y138 = _FlipbookY;
				float2 appendResult132 = (float2(flipbook_X137 , flipbook_Y138));
				float Random_Offset143 = packedInput.ase_texcoord2.x;
				...
				surfaceDescription.Color = ( ( packedInput.ase_color * float4( hsvTorgb125 , 0.0 ) ) * _Emissive ).rgb;
		...
		Pass
		{
					...
					)
			{
				...
				float mainTex_alpha48 = tex2DNode45.a;
				float mainTex_VC_alpha52 = packedInput.ase_color.a;
				float Opacity_VTC_W33 = packedInput.ase_texcoord.z;
				float Opacity_VTC_T30 = packedInput.ase_texcoord.w;
				float temp_output_44_0 = (( Opacity_VTC_T30 - 1.0 ) + (Opacity_VTC_W33 - 0.0) * (1.0 - ( Opacity_VTC_T30 - 1.0 )) / (1.0 - 0.0));
				float2 texCoord133 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float flipbook_X137 = _FlipbookX;
				float flipbook_Y138 = _FlipbookY;
				float2 appendResult132 = (float2(flipbook_X137 , flipbook_Y138));
				float Random_Offset143 = packedInput.ase_texcoord1.x;
				float smoothstepResult54 = smoothstep( temp_output_44_0 , ( temp_output_44_0 + Opacity_VTC_T30 ) , tex2D( _disolveMap, ( ( ( texCoord133 * appendResult132 ) * _DissolveMapScale ) + Random_Offset143 ) ).g);
				float disolveMapping56 = smoothstepResult54;
				float OpacityRegister61 = ( ( mainTex_alpha48 * mainTex_VC_alpha52 ) * disolveMapping56 );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord19 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner27 = ( 1.0 * _Time.y * _UVP + ( texCoord19 * _UVS ));
				...
				float mainTex_alpha48 = tex2DNode45.a;
				float mainTex_VC_alpha52 = packedInput.ase_color.a;
				float Opacity_VTC_W33 = packedInput.ase_texcoord2.z;
				float Opacity_VTC_T30 = packedInput.ase_texcoord2.w;
				float temp_output_44_0 = (( Opacity_VTC_T30 - 1.0 ) + (Opacity_VTC_W33 - 0.0) * (1.0 - ( Opacity_VTC_T30 - 1.0 )) / (1.0 - 0.0));
				float2 texCoord133 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float flipbook_X137 = _FlipbookX;
				float flipbook_Y138 = _FlipbookY;
				float2 appendResult132 = (float2(flipbook_X137 , flipbook_Y138));
				float Random_Offset143 = packedInput.ase_texcoord3.x;
				float smoothstepResult54 = smoothstep( temp_output_44_0 , ( temp_output_44_0 + Opacity_VTC_T30 ) , tex2D( _disolveMap, ( ( ( texCoord133 * appendResult132 ) * _DissolveMapScale ) + Random_Offset143 ) ).g);
				float disolveMapping56 = smoothstepResult54;
				float OpacityRegister61 = ( ( mainTex_alpha48 * mainTex_VC_alpha52 ) * disolveMapping56 );
...
WireConnection;146;2;73;0
ASEEND*/
//CHKSM=477D0E6C2A3F87CF850E5BE18892D1A215C07D0F